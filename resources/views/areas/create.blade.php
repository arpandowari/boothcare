...
@section('title', 'Create Area - Boothcare')
@section('page-title', 'Create New Area')
...
<div class="container-fluid">
    ...
    <div class="create-header">
        <h1><i class="fas fa-plus-circle me-2"></i>Create New Area</h1>
        <p class="subtitle">Add a new geographical area to organize booths and constituencies</p>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('areas.store') }}" method="POST" id="createAreaForm">
                    @csrf
