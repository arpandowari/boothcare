...
@section('title', 'Create Booth - Boothcare')
@section('page-title', 'Create New Booth')
...
<div class="container-fluid">
    ...
    <div class="create-header">
        <h1><i class="fas fa-building me-2"></i>Create New Booth</h1>
        <p class="subtitle">Add a new polling booth to organize houses and constituencies</p>
    </div>
    ...
    <div class="form-container">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('booths.store') }}" method="POST" id="createBoothForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4" 
                                  placeholder="Optional description about this booth">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
